...
public class CamionetaVerde extends Personaje {

	public CamionetaVerde(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);

	}

	public CamionetaVerde(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);

	}

	public CamionetaVerde(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, Animation.PlayMode modo,
			Pantalla pantalla) {
