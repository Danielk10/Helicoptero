...
public class CarroGris extends Personaje {

	public CarroGris(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);

	}

	public CarroGris(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);

	}

	public CarroGris(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, Animation.PlayMode modo,
			Pantalla pantalla) {
