...
public class BalaEnemigo extends Personaje {
	...
	public BalaEnemigo(Texture textura, Pantalla pantalla) {
	...
	public BalaEnemigo(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public BalaEnemigo(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, Animation.PlayMode modo,
			Pantalla pantalla) {
