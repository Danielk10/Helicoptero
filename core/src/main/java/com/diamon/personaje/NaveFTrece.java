...
public class NaveFTrece extends Personaje {
	...
	public NaveFTrece(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public NaveFTrece(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo, Pantalla pantalla) {
