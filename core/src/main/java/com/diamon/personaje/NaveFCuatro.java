...
public class NaveFCuatro extends Personaje {
	private float tiemo;
	...
	public NaveFCuatro(Texture textura, Pantalla pantalla) {
	...
	public NaveFCuatro(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public NaveFCuatro(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo, Pantalla pantalla) {
