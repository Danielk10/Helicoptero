...
public class CarroAmarillo extends Personaje {

	public CarroAmarillo(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);

	}

	public CarroAmarillo(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);

	}

	public CarroAmarillo(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, Animation.PlayMode modo,
			Pantalla pantalla) {
