...
public class CajaHelicopteroVerde extends Personaje {
	...
	public CajaHelicopteroVerde(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);
		// TODO Auto-generated constructor stub
	}

	public CajaHelicopteroVerde(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);
		// TODO Auto-generated constructor stub
	}

	public CajaHelicopteroVerde(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo,
			Pantalla pantalla) {
	...
	private void agregarItem() {
		...
		ItemDeJuego item = new ItemDeJuego(
				recurso.get("textura/helicopteroVerde.atlas", TextureAtlas.class).getRegions().get(0), pantalla);
		...
		item.setItem(ItemDeJuego.HELICOPTERO_VERDE);
