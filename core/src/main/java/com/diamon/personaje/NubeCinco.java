...
public class NubeCinco extends Personaje {

	private float velocidadX;

	public static final float VELOCIDAD = 0.5F;

	public NubeCinco(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);
		velocidadX = VELOCIDAD;
	}

	public NubeCinco(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);
		velocidadX = VELOCIDAD;
	}

	public NubeCinco(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, Animation.PlayMode modo,
			Pantalla pantalla) {
