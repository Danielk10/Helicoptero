...
public class CajaHelicopteroMedico extends Personaje {
	...
	public CajaHelicopteroMedico(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);
		// TODO Auto-generated constructor stub
	}

	public CajaHelicopteroMedico(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);
		// TODO Auto-generated constructor stub
	}

	public CajaHelicopteroMedico(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo,
			Pantalla pantalla) {
	...
	private void agregarItem() {
		...
		ItemDeJuego item = new ItemDeJuego(
				recurso.get("textura/helicopteroMedico.atlas", TextureAtlas.class).getRegions().get(0), pantalla);
		...
		item.setItem(ItemDeJuego.HELICOPTERO_MEDICO);
