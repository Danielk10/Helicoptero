...
public class NaveFCatorce extends Personaje {
	private float tiemo;
	...
	public NaveFCatorce(Texture textura, Pantalla pantalla) {
	...
	public NaveFCatorce(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public NaveFCatorce(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo, Pantalla pantalla) {
