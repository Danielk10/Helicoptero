...
public class CajaHelicopteroNegro extends Personaje {
	...
	public CajaHelicopteroNegro(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);
		// TODO Auto-generated constructor stub
	}

	public CajaHelicopteroNegro(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);
		// TODO Auto-generated constructor stub
	}

	public CajaHelicopteroNegro(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo,
			Pantalla pantalla) {
	...
	private void agregarItem() {
		...
		ItemDeJuego item = new ItemDeJuego(
				recurso.get("textura/helicopteroNegro.atlas", TextureAtlas.class).getRegions().get(0), pantalla);
		...
		item.setItem(ItemDeJuego.HELICOPTERO_NEGRO);
