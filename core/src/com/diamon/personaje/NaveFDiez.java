...
public class NaveFDiez extends Personaje {
	...
	public NaveFDiez(Texture textura, Pantalla pantalla) {
	...
	public NaveFDiez(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public NaveFDiez(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo, Pantalla pantalla) {
