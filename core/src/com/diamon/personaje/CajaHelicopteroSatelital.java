...
public class CajaHelicopteroSatelital extends Personaje {
	...
	public CajaHelicopteroSatelital(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);
		// TODO Auto-generated constructor stub
	}

	public CajaHelicopteroSatelital(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);
		// TODO Auto-generated constructor stub
	}

	public CajaHelicopteroSatelital(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo,
			Pantalla pantalla) {
	...
	private void agregarItem() {
		...
		ItemDeJuego item = new ItemDeJuego(
				recurso.get("textura/elicoptero1.atlas", TextureAtlas.class).getRegions().get(0), pantalla);
		...
		item.setItem(ItemDeJuego.HELICOPTERO_SATELITAL);
