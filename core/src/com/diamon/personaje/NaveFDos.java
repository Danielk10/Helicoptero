...
public class NaveFDos extends Personaje {
	...
	public NaveFDos(Texture textura, Pantalla pantalla) {
	...
	public NaveFDos(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public NaveFDos(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo, Pantalla pantalla) {
