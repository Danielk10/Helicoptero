...
public class NaveFUno extends Personaje {
	...
	public NaveFUno(Texture textura, Pantalla pantalla) {
	...
	public NaveFUno(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public NaveFUno(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo, Pantalla pantalla) {
