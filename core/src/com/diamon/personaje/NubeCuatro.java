...
public class NubeCuatro extends Personaje {

	private float velocidadX;

	public static final float VELOCIDAD = 0.5F;

	public NubeCuatro(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);
		velocidadX = VELOCIDAD;
	}

	public NubeCuatro(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);
		velocidadX = VELOCIDAD;
	}

	public NubeCuatro(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, Animation.PlayMode modo,
			Pantalla pantalla) {
