...
public class NubeLarga extends Personaje {

	private float velocidadX;

	public static final float VELOCIDAD = 0.5F;

	public NubeLarga(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);
		velocidadX = VELOCIDAD;
	}

	public NubeLarga(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);
		velocidadX = VELOCIDAD;
	}

	public NubeLarga(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, Animation.PlayMode modo,
			Pantalla pantalla) {
