...
public class NaveFNueve extends Personaje {
	...
	public NaveFNueve(Texture textura, Pantalla pantalla) {
	...
	public NaveFNueve(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public NaveFNueve(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo, Pantalla pantalla) {
