...
public class CamionetaGris extends Personaje {

	public CamionetaGris(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);

	}

	public CamionetaGris(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);

	}

	public CamionetaGris(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, Animation.PlayMode modo,
			Pantalla pantalla) {
