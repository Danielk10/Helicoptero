...
public class PlatilloA extends Personaje {
	...
	public PlatilloA(Texture textura, Pantalla pantalla) {
	...
	public PlatilloA(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public PlatilloA(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo, Pantalla pantalla) {
