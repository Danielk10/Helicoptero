...
public class CajaVelocidad extends Personaje {
	...
	public CajaVelocidad(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);
		// TODO Auto-generated constructor stub
	}

	public CajaVelocidad(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);
		// TODO Auto-generated constructor stub
	}

	public CajaVelocidad(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo, Pantalla pantalla) {
	...
	private void agregarItem() {
		...
		item.setItem(ItemDeJuego.VELOCIDAD);
