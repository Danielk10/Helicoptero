...
public class NaveFOnce extends Personaje {
	...
	public NaveFOnce(Texture textura, Pantalla pantalla) {
	...
	public NaveFOnce(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public NaveFOnce(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo, Pantalla pantalla) {
