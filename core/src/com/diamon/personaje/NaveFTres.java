...
public class NaveFTres extends Personaje {
	...
	public NaveFTres(Texture textura, Pantalla pantalla) {
	...
	public NaveFTres(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public NaveFTres(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo, Pantalla pantalla) {
