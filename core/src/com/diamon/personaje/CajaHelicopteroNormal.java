...
public class CajaHelicopteroNormal extends Personaje {
	...
	public CajaHelicopteroNormal(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);
		// TODO Auto-generated constructor stub
	}

	public CajaHelicopteroNormal(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);
		// TODO Auto-generated constructor stub
	}

	public CajaHelicopteroNormal(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo,
			Pantalla pantalla) {
	...
	private void agregarItem() {
		...
		ItemDeJuego item = new ItemDeJuego(
				recurso.get("textura/helicoptero.atlas", TextureAtlas.class).getRegions().get(0), pantalla);
		...
		item.setItem(ItemDeJuego.HELICOPTERO_NORMAL);
