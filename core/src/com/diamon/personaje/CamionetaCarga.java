...
public class CamionetaCarga extends Personaje {

	public CamionetaCarga(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);

	}

	public CamionetaCarga(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);

	}

	public CamionetaCarga(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, Animation.PlayMode modo,
			Pantalla pantalla) {
