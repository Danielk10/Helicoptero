...
public class NubeUno extends Personaje {

	private float velocidadX;

	public static final float VELOCIDAD = 0.5F;

	public NubeUno(Texture textura, Pantalla pantalla) {
		super(textura, pantalla);
		velocidadX = VELOCIDAD;
	}

	public NubeUno(TextureRegion texturaRegion, Pantalla pantalla) {
		super(texturaRegion, pantalla);
		velocidadX = VELOCIDAD;
	}

	public NubeUno(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, Animation.PlayMode modo,
			Pantalla pantalla) {
