...
public class NaveFOcho extends Personaje {
	...
	public NaveFOcho(Texture textura, Pantalla pantalla) {
	...
	public NaveFOcho(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public NaveFOcho(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo, Pantalla pantalla) {
