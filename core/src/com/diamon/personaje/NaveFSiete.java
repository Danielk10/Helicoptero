...
public class NaveFSiete extends Personaje {
	...
	public NaveFSiete(Texture textura, Pantalla pantalla) {
	...
	public NaveFSiete(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public NaveFSiete(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo, Pantalla pantalla) {
