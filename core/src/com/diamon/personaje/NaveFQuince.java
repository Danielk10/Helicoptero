...
public class NaveFQuince extends Personaje {
	...
	public NaveFQuince(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public NaveFQuince(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo, Pantalla pantalla) {
