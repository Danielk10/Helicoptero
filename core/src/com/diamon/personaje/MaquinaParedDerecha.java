...
public class MaquinaParedDerecha extends Personaje {
	...
	public MaquinaParedDerecha(Texture textura, Pantalla pantalla) {
	...
	public MaquinaParedDerecha(TextureRegion texturaRegion, Pantalla pantalla) {
	...
	public MaquinaParedDerecha(Array<AtlasRegion> texturaRegion, float tiempoAnimacion, PlayMode modo,
			Pantalla pantalla) {
	...
	public void disparar(int lado) {
		...
		bala.setPosition(x + getWidth(), y + getHeight() / 2);
